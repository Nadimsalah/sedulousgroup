...
export default function AddFlexiHireCarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const carToAdd = {
        ...
        pricePerDay: Number.parseFloat(carData.pricePerMonth), // Convert monthly to daily field
        ...
        rentalType: "Flexi Hire" as const,
      }
      ...
      if (previewImages.length > 0 && result.id) {
        ...
        if (!imagesResult.success) {
          ...
          alert("Flexi Hire car published successfully with all images!")
        }
      } else {
        alert("Flexi Hire car published successfully!")
      }

      router.push("/admin/flexi-hire")
    } catch (error) {
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#000000" }}>
      <header className="liquid-glass border-b border-white/10 px-8 py-6">
        <div className="max-w-5xl mx-auto">
          <Link href="/admin/flexi-hire" className="inline-flex items-center gap-2 text-white/60 hover:text-white mb-4">
            <ArrowLeft className="h-5 w-5" />
            Back to Flexi Hire
          </Link>
          <h1 className="text-2xl font-bold text-white">Add New Flexi Hire Car</h1>
          <p className="text-sm text-white/60">Publish a new car for flexi hire on the website</p>
        </div>
      </header>

      <div className="p-8 bg-black">
        <form onSubmit={handleSubmit} className="max-w-5xl mx-auto">
          <div className="liquid-glass rounded-2xl border border-white/10 shadow-sm p-8 space-y-8">
            <div>
            ...
            <div className="flex gap-4 pt-6 border-t border-white/10">
              <Link href="/admin/flexi-hire" className="flex-1">
                <Button
                  type="button"
                  variant="outline"
