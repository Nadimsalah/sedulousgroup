...
export default function PCOHireManagementPage() {
  ...
  const loadCars = async () => {
    ...
    try {
      ...
      const pcoHireCars = fetchedCars.filter((car) => car.rentalType === "PCO Hire")
      setCars(pcoHireCars)
      const loadingStates: Record<string, boolean> = {}
      pcoHireCars.forEach((car) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white">PCO Hire Management</h1>
          <p className="text-white/60 mt-1">Manage your PCO hire fleet - {cars.length} cars</p>
        </div>
        <Link href="/admin/pco-hire/add">
      ...
      {cars.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          <div className="liquid-glass-enhanced rounded-3xl border-white/20 p-12 max-w-lg w-full text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-3">No PCO Hire Cars Yet</h2>
            <p className="text-white/60 mb-8">
              Start building your PCO hire fleet by adding your first car. Create listings with photos, pricing, and
              specifications.
            </p>
            <Link href="/admin/pco-hire/add">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link href={`/admin/pco-hire/${car.id}/edit`} className="flex-1">
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full text-white/70 hover:text-white border-white/20 hover:bg-white/10 bg-transparent"
